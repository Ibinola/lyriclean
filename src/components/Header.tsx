...
export default function Header() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("lyriclean:darkMode");
  ...
  const toggleDark = () => {
    ...
    localStorage.setItem("lyriclean:darkMode", next ? "dark" : "light");
  };
      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-xs text-muted-foreground transition-colors hover:border-indigo-600 hover:text-indigo-600"
          >
